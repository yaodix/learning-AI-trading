...
* **Data Cleaning** :
  * changing the format and type of data, and fixing corrupted or missing data.
  * sometimes dropping insignificant data points is more efficient than trying to fix them.
* **Data Transformation**
...
* nornalization 和standardizing 实际使用中顺序不可互换
